...
from models.sincos_model import Euclidean, Chi2, Chybyshev, Manhattan, SquaredChord
...
parser.add_argument("--n_epochs", type=int, default=64, help="number of epochs of training")
...
def main():
    ...
    for model_loop in range(loop_start, all_model, 1):
        ...
        savepath = createFolder(
            f"../sincos_result/H{opt.n_bin}_B{opt.batch_size}_lr{opt.Glr}_{opt.Dlr}/{opt.dataset}_images/{loss_function_name[model_select]}/")
