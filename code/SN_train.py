...
from models.SN_model import Generator, Discriminator
...
def main():
    ...
    for model_loop in range(loop_start, all_model, 1):
        ...
        savepath = createFolder(
            f"../SN_result/H{opt.n_bin}_B{opt.batch_size}_lr{opt.Glr}_{opt.Dlr}/{opt.dataset}_images/{loss_function_name[model_select]}/")
